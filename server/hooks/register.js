...
//         var apiFormat =
//           'http://api.madmimi.com/audience_lists/' + '%s/add?email=%s&username=%s&api_key=%s';
...
//           // may be do retrying
//           if (err) {
//             var errorMessage = 'error sending user email: ' + userEmail + ' error: ' + err.message;
//             console.error(errorMessage);
//           } else if (response.statusCode !== 200) {
//             var warnMessage =
//               'error(not 200) sending user email: ' + userEmail + ' error: ' + response.content;
