// var originalUpdateOrCreateUserFromExternalService = Accounts.updateOrCreateUserFromExternalService;
...
//         throw new Meteor.Error(403, i18n('signIn.already_connected_meteor_dev_account'));
//       } else {
//         var setAttr = {};
...
//       throw new Meteor.Error(403, i18n('signIn.already_registed_via_email', existingEmail));
//     }
//   }
